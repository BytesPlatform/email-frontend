        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-slate-400 mb-6 max-w-md">
              Streamline your email marketing with powerful CSV ingestion, 
              intelligent web scraping, and comprehensive analytics.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/dashboard/csv-ingestion" className="text-slate-400 hover:text-white transition-colors">
                  CSV Ingestion
                </Link>
              </li>
              <li>
                <Link href="/dashboard/scraping" className="text-slate-400 hover:text-white transition-colors">
                  Web Scraping
                </Link>
              </li>
            </ul>
